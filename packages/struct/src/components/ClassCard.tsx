    ...
    >
      <div className="flex justify-between items-start mb-2">
        <div className="flex items-start space-x-2 min-w-0 flex-1">
          {classData.isPinned && (
            <div title="Pinned class" aria-hidden="true">
              <PinIcon isPinned={true} className="text-green-400 w-5 h-5 mt-1" />
            </div>
          )}
          {editingName !== null ? (
            <input
        ...
        <div className="flex items-center space-x-1">
          ...
          >
            {!classData.isPinned && (
              <div title="Not pinned class" aria-hidden="true">
                <PinIcon isPinned={false} />
              </div>
            )}
          </button>
          <button
